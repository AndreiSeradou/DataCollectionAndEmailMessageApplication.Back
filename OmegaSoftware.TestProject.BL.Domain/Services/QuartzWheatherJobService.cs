...
{
    public class QuartzWheatherJobService : IQuartzJobService<WheatherSubscriptionDTOs>
    {
        ...
        public async Task CreateJobAsync(string email, WheatherSubscriptionDTOs model)
        {
        ...
        public void DeleteJob(WheatherSubscriptionDTOs model)
        {
        ...
        public async Task UpdateJobAsync(string email, WheatherSubscriptionDTOs model)
        {
            DeleteJob(model);
